...
import com.delivery.storefranchise.domain.authorization.AuthorizationService;
import com.delivery.storefranchise.domain.authorization.JsonUsernamePasswordAuthenticationFilter;
...
public class SecurityConfig {
    ...
    public DaoAuthenticationProvider daoAuthenticationProvider() throws Exception {
        ...
        daoAuthenticationProvider.setPasswordEncoder(passwordEncoder());    // TODO 이미 여기서 넣었으니 아래 설정 빼도 되는지 확인 필요
